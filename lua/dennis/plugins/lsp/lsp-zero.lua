return {
    ...
    config = function()
        ...
        lsp_zero.on_attach(function(client, bufnr)
            ...
            vim.keymap.set("n", "<leader>gd", function() vim.lsp.buf.definition() end, { desc = '[G]o to [D]efinition', buffer = bufnr, remap = false })
            vim.keymap.set("n", "<leader>h", function() vim.lsp.buf.hover() end, { desc = '[H]over', buffer = bufnr, remap = false })
